...
//While we use the term buttons to describe these bits for the sake of simplicity,
//it's better to think of them as intents, as by this point, key mappings have been processed
//in cabling. So "stickflick" might map a triple tap of w,a,s, or d in mkb. (www, aaa, sss, ddd only)
...
public:
	...
	{
		return DebiasStick(ly.to_ulong());
	}
	
	int32_t GetStickLeftXAsACSN()
	{
		return DebiasStick(lx.to_ulong());
	}
