...
//   Jolt/Core/InsertionSort.h — SPDX-FileCopyrightText: 2022 Jorrit Rouwe
//   SPDX-License-Identifier: MIT
//
// Algorithm is byte-for-byte Jolt's. Booster adaptations only:
//   * JPH_NAMESPACE_BEGIN/END  -> namespace booster_sort
//   * explicit <utility>/<functional> includes (no Jolt Core.h prerequisite)
// Vendored so the rtree carries no external Jolt dependency. See thirdparty/DETERMINISM.md.
#pragma once
