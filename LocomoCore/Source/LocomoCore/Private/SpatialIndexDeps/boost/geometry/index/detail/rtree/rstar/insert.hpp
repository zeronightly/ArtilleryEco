...
// VENDORED PATCH (Booster) — DETERMINISM. See thirdparty/DETERMINISM.md.
#include <booster_sort/quick_sort.h>
...
public:
                             ...
                             allocators_type & allocators)
    {
        ...
        // sort elements by distances from center. VENDORED PATCH (Booster): std::partial_sort
        // -> full booster_sort::QuickSort. A fully-sorted range has the identical leading
        // reinserted_elements_count prefix as partial_sort, and QuickSort is deterministic
        // across STLs (std::partial_sort's equal-key arrangement is impl-defined). See DETERMINISM.md.
        booster_sort::QuickSort(
