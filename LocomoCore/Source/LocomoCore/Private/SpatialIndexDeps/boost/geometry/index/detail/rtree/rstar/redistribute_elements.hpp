...
struct choose_split_axis_and_index_for_corner
{
                             ...
                             Translator const& translator)
    {
        ...
        // VENDORED PATCH (Booster): std::sort -> booster_sort::QuickSort (deterministic across STLs)
        booster_sort::QuickSort(elements_copy.begin(), elements_copy.end(), elements_less);                                   // MAY THROW, BASIC (copy)
//        {
